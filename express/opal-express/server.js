    ...
    socket.on('process-video',async (data)=>{
        ...
        fs.readFile('temp_upload/'+data.filename,async(err,file)=>{
            ...
            if(processing.data.status!==200)
                return console.log('Error:something went wronng with creating processing file')
                                ...
                                if(transcription){
                                    const completion=await openai.chat.completions.create({
                                        ...
                                        messages:[
                                            {
                                                role:'system',
                                                content:`You are going to generate a title and a nice description using the speech to text transcription provided: transcription(${transcription}) and then return it in json format as {"title":<the title ypu gave>,"summary:<the summary you created>}`,
