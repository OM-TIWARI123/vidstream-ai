        ...
        <div>
            {/* <div className="grid grid-cols-1:lg:grid-cols-3 gap-10">
                <div className="lg:col-span-4 flex lg:flex-row flex-col items-start gap-5">
                    <div className={cn('rounded-2xl overflow-hidden cursor-pointer border-4 border-transparent',theme=='system && border-purple-800')} onClick={()=>setTheme('system')}>
                        <SystemMode/> 
                    </div>
                    <div className={cn('rounded-2xl overflow-hidden cursor-pointer border-4 border-transparent',theme=='light && border-purple-800')} onClick={()=>setTheme('light')}>
                        <LightMode/>
                    </div>
                    <div className={cn('rounded-2xl overflow-hidden cursor-pointer border-4 border-transparent',theme=='dark && border-purple-800')} onClick={()=>setTheme('dark')}>
                        <DarkMode/>
                    </div>
                </div>
            ...
            <p className='text-muted-foreground'>
                Enabling this feature will send you notifications when someone watched ypur video for the first time. This feature can help during client outreach
