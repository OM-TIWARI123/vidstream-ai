...
const VideoPreview=({videoId}:Props)=>{
    ...
    const {data}=userQueryData(['preview-video'],()=>
    ...
    return (
       <div className='grid grid-cols-1 xl:grid-cols-3 p-10  lg:py-10 overflow-y-auto gap-5'>
            <div className='flex flex-col lg:col-span-2 gap-y-10'>
                <div>
                    ...
                    <span className='flex gap-x-3 mt-2'>
                        <p className='text-[#9D9D9D] capitlize'>
            ...
            <div className='lg:col-span-1 flex flex-col gap-y-16'>
              ...
              <div>
                <TabMenu
                defaultValue='Ai tools' triggers={['Ai tools','Transcript','Activity']}>
                    <AiTools
                    videoId={videoId}
                    trial={video.User?.trial!}
                    plan={video.User?.subscription?.plan!}/>
                <VideoTranscript transcript={video.summery!}/>
                <Activities author={author ? video.User?.firstname || '' : ''} videoId={videoId}/>
